...
function genesis_sample_woocommerce_styles( $enqueue_styles ) {
	...
	$enqueue_styles['damsko-woocommerce-styles'] = array(
		'src'     => get_stylesheet_directory_uri() . '/lib/woocommerce/damsko-woocommerce.css',
		'deps'    => '',
...
function genesis_sample_woocommerce_css() {
	...
	if ( $woo_css ) {
		wp_add_inline_style( 'damsko-woocommerce-styles', $woo_css );
	}
