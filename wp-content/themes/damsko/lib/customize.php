...
function genesis_sample_customizer_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'genesis_sample_link_color',
			array(
				'description' => __( 'Change the color of post info links, hover color of linked titles, hover color of menu items, and more.', 'damsko' ),
				'label'       => __( 'Link Color', 'damsko' ),
				'section'     => 'colors',
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'genesis_sample_accent_color',
			array(
				'description' => __( 'Change the default hovers color for button.', 'damsko' ),
				'label'       => __( 'Accent Color', 'damsko' ),
				'section'     => 'colors',
	...
	$wp_customize->add_control(
		'genesis_sample_logo_width',
		array(
			'label'       => __( 'Logo Width', 'damsko' ),
			'description' => __( 'The maximum width of the logo in pixels.', 'damsko' ),
			'priority'    => 9,
